...
IMPORTANT: If you find a title or heading text (typically displayed prominently, in larger font, centered, or styled differently), extract it and set "isTitle": true. Titles are usually:
- Displayed at the top of sections
- In larger or bold font
- Centered or prominently positioned
- May be in a different color (often red or darker)
...
- If you find no sentences, return an empty array: []${vocabularyContext}`;
        ...
        let sentences: Array<{ arabic: string; english?: string; isTitle?: boolean }> = [];
        let duplicates: Array<{ arabic: string; english?: string; isTitle?: boolean }> = [];
        ...
        try {
            ...
            sentences = sentences
                ...
                .map((s) => ({
                    ...
                    isTitle: s.isTitle === true, // Explicitly set to false if not true
                }))
